...
class kenwoodTK:
    ...
    def __init__ (addr) :
        ...
        """
        self.i2cBus.write_i2c_block_data(adder,CONFIG_L,[ALLOUT,ALLOUT]);
        self.i2cBus.write_byte_data(addr,MASTERO16,(MASTERSTATIC |  O16STATIC))
        self.i2cBus.write_byte_data(addr,CONFIG,(O16P0 |  GLOBINTEN |  BLINKEN))

    def setFreqDirect(tx_freq, rx_freq) :
        if(tx_freq < 200000) :
