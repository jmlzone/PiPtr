...
try:
    ...
    print("Warning: Neopixel librayr not found, continuing with out it")
    print("Try:")
    print("    git clone https://github.com/rpi-ws281x/rpi-ws281x-python")
    print("    cd rpi-ws281x-python/library")
    print("    rmdir lib")
    print("    ln -s ../../rpi_ws281x lib")
